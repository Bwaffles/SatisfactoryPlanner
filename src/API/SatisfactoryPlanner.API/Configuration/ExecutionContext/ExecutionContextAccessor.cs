...
{
    public class ExecutionContextAccessor(IHttpContextAccessor httpContextAccessor, IUserAccessModule userAccessModule)
        : IExecutionContextAccessor
    {
        ...
        public Guid UserId
        {
            get
            {
                ...
                var getCurrentUserTask = userAccessModule.ExecuteQueryAsync(new GetUsersQuery(auth0UserId));
