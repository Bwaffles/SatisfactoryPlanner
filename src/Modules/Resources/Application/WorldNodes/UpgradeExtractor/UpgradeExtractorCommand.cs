...
public class UpgradeExtractorCommand(Guid worldId, Guid nodeId, Guid extractorId) : CommandBase
{
...
internal class UpgradeExtractorCommandHandler(IExtractorRepository extractorRepository,
    IWorldNodeRepository worldNodeRepository,
    INodeRepository nodeRepository) : ICommandHandler<UpgradeExtractorCommand>
{
