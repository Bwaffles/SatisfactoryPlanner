...
public class PublishExtractionRateDecreasedIntegrationEvent(IEventsBus eventsBus, IDbConnectionFactory dbConnectionFactory) : IDomainEventNotificationHandler<ExtractionRateDecreasedNotification, ExtractionRateDecreasedDomainEvent>
{
    private readonly IEventsBus _eventsBus = eventsBus;
    private readonly IDbConnectionFactory _dbConnectionFactory = dbConnectionFactory;

    public async Task Handle(ExtractionRateDecreasedNotification notification, CancellationToken cancellationToken)
    {
        ...
        await _eventsBus.Publish(new ExtractionRateDecreasedIntegrationEvent(
