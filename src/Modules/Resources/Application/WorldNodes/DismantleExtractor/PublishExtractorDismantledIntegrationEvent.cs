...
public class PublishExtractorDismantledIntegrationEvent(IEventsBus eventsBus, IDbConnectionFactory dbConnectionFactory) : IDomainEventNotificationHandler<ExtractorDismantledNotification, ExtractorDismantledDomainEvent>
{
    private readonly IEventsBus _eventsBus = eventsBus;
    private readonly IDbConnectionFactory _dbConnectionFactory = dbConnectionFactory;

    public async Task Handle(ExtractorDismantledNotification notification, CancellationToken cancellationToken)
    {
        ...
        await _eventsBus.Publish(new ExtractorDismantledIntegrationEvent(
