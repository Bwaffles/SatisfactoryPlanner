...
public class ExtractionRateDecreasedIntegrationEvent(Guid id, DateTime occurredOn, Guid worldId, Guid nodeId, string itemId, decimal rate) : IntegrationEvent(id, occurredOn)
{
