...
using SatisfactoryPlanner.Modules.Warehouses.Infrastructure.Outbox;

namespace SatisfactoryPlanner.Modules.Warehouses.Infrastructure.Configuration.Processing.Outbox
{
