...
namespace SatisfactoryPlanner.Modules.Warehouses.Infrastructure.Configuration.DataAccess
{
    /// <summary>
    ///     Dependency injection setup for Data Access of the Warehouses module.
    ...
    internal class DataAccessModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder
                .Register(c =>
                {
                    var dbContextOptionsBuilder = new DbContextOptionsBuilder<WarehousesContext>();
                    dbContextOptionsBuilder.UseNpgsql(_databaseConnectionString);
                    dbContextOptionsBuilder
                        .ReplaceService<IValueConverterSelector, StronglyTypedIdValueConverterSelector>();

                    return new WarehousesContext(dbContextOptionsBuilder.Options, _loggerFactory);
                })
                .AsSelf()
                .As<DbContext>()
                .InstancePerLifetimeScope();
