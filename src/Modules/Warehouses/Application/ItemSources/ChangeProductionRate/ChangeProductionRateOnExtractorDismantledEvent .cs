...
public class ChangeProductionRateOnExtractorDismantledEvent(ICommandsScheduler commandsScheduler) : INotificationHandler<ExtractorDismantledIntegrationEvent>
{
    private readonly ICommandsScheduler _commandsScheduler = commandsScheduler;

    public async Task Handle(ExtractorDismantledIntegrationEvent notification, CancellationToken cancellationToken)
